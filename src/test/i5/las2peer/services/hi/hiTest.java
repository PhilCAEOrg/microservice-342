 ...
 * 342 - Test Class
 *
 * This class provides a basic testing framework for the microservice 342. It was
...
public class hiTest {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(hi.class.getCanonicalName(),"0.1");

  private static final String mainPath = "hi";
  ...
  public void testhi() {
    ...
    try {
      ...
      ClientResponse result = c.sendRequest("GET", mainPath + "/hi", hi.toJSONString(),
        MediaType.APPLICATION_JSON, MediaType.APPLICATION_JSON, new HashMap<String,String>());
      assertTrue(true); // change here
      System.out.println("Result of 'testhi': " + result.getResponse().trim());
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
    }
